...
```
###Не използвайте type атрибута при инклудването файл
...
В слаучай, че името на Вашият class или ID се състои от няколко думи, правилният начин за изписването на класа е чрез свързващият символ "-":
...
###Винаги започвайте всеки селектори на нов ред
